...
ins(
	quests,
	{
		...
		"Fence Placer",
		nil,
		{"default:fence_wood", "default:fence_junglewood", "default:fence_acacia_wood", "default:fence_pine_wood", "default:fence_aspen_wood"},
		3,
		{mod..":gate_wood_closed", mod..":gate_junglewood_closed", mod..":gate_acacia_wood_closed", mod..":gate_pine_wood_closed", mod..":gate_aspen_wood_closed"},
		"sticks_crafter",
		type = t,
		group = wood
	})
...
ins(
	...
	{
		'obsidian_glass_builder',
		"Obsidian Glass Builder",
		nil,
		{"default:obsidian_glass"},
		3,
		{mod..":door_obsidian_glass"},
		"obsidian_digger",
		type = t,
		group = middle
	})
