...
if redo then
	...
	ins(
		quests,
		{
			...
			{mod..":donut"},
			1,
			{mod..":donut_apple", mod..":donut_chocolate"},
			"book_crafter",
			type = "craft",
			group = farm
		})
...
ins(
	quests,
	{
		...
		"Wheat Digger",
		nil,
		{mod..":wheat_1", mod..":wheat_2", mod..":wheat_3", mod..":wheat_4", mod..":wheat_5", mod..":wheat_6", mod..":wheat_7", mod..":wheat_8"},
		9,
		{mod..":straw", mod..":wheat"},
		"book_crafter",
		type = t,
...
if redo then
	...
	ins(
		quests,
		{
			...
			"Cocoa Digger",
			"cocoa fruits",
			{mod..":cocoa_1", mod..":cocoa_2", mod..":cocoa_3"},
			3,
			{mod..":chocolate_dark"},
			nil,
			type = t,
	...
	ins(
		quests,
		{
			...
			"Squash Digger",
			"pumpkins or melons",
			{mod..":melon_8", mod..":pumpkin_8", mod..":pumpkin"},
			1,
			{mod..":melon_slice", mod..":melon_8", mod..":pumpkin_slice", mod..":pumpkin"},
			"book_crafter",
			type = t,
			group = farm
		})
...
ins(
	quests,
	{
		...
		{mod..":straw"},
		3,
		{"stairs:slab_straw", "stairs:stair_straw"},
		"wheat_digger",
		type = t
	})
