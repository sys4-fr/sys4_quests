...
and minetest.get_modpath("food") then
   ...
   ins(quests, {
	  'cooker', "Become a cooker", "basic food ingredients (apples, cactus, oranges, ...)", ingredients, 1, cooked_food, "furnace_crafter", type = t, group = stone
	       })
   ...
   cooked_food = {mod..":cakemix_plain", mod..":cakemix_carrot", mod..":cakemix_choco", mod..":chocolate_powder",
		  mod..":pasta"}

   ins(quests, {
	  'cooker_lover', "Cooker Lover", "juices, ingredients or already known cooked meals", ingredients2, 1, cooked_food, "cooker", type = t, group = stone
	       })
   ...
   ins(quests, {
	  'cooker_pro', "Cooker Pro", "elaborate ingredients or cooked meals", ingredients3, 1, cooked_food, "iron_digger_pro", type = t, group = metal
	       })
   ...
   if minetest.get_modpath("food_sweet") then
	 ...
	 up('cooker', nil, {mod..":blueberry", mod..":rhubarb"})
      ...
      local food_t = {mod..":cakemix_walnut_coffee", mod..":crumble_rhubarb_raw",
		      mod..":cupcake_mix", mod..":muffin_blueberry_mix"}
	 ...
	 ins(ingredients_t, i)
      ...
      up('cooker_pro', ingredients_t, {mod..":cake_wedding", mod..":cakemix_cheese", mod..":cakemix_cheese_blueberry",
			     mod..":cakemix_triple_choco", mod..":cupcake_choco_mix", mod..":cupcake_fairy",
