...
and minetest.get_modpath("ethereal") then
	...
	sys4_quests.addInitialStuff("ethereal:bamboo_sprout 3")
	...
	if minetest.get_modpath("moreblocks_quets") then
		...
		ins(
			quests,
			{
				...
				dirtNodes,
				1,
				{"default:desert_sand", mod..":bonemeal", mod..":worm"},
				nil,
				type = "dig",
				group = dark
			})
	...
	local fenceNodes = {
		...
		mod..":fence_scorched",
		mod..":fence_willow",
		mod..":fence_yellowwood"
	}
	local fenceGates = {
		mod..":fencegate_banana_closed",
		mod..":fencegate_birch_closed",
		mod..":fencegate_frostwood_closed",
		mod..":fencegate_mushroom_closed",
		mod..":fencegate_palm_closed",
		mod..":fencegate_redwood_closed",
		mod..":fencegate_scorched_closed",
		mod..":fencegate_willow_closed",
		mod..":fencegate_yellowwood_closed"
	}

	local woodStairsNodes = {
		"stairs:slab_banana_wood",
		"stairs:slab_birch_wood",
		"stairs:slab_frost_wood",
		"stairs:slab_palm_wood",
		"stairs:slab_redwood_wood",
		"stairs:slab_willow_wood",
		"stairs:slab_yellow_wood",
		"stairs:stair_banana_wood",
		"stairs:stair_birch_wood",
		"stairs:stair_frost_wood",
		"stairs:stair_palm_wood",
		"stairs:stair_redwood_wood",
		"stairs:stair_willow_wood",
		"stairs:stair_yellow_wood"
	}
	...
	ins(
		quests,
		{
			...
			"Leaves Digger",
			nil,
			{"default:leaves", "default:acacia_leaves", "default:aspen_leaves", "default:jungleleaves", "default:pine_needles", mod..":bamboo_leaves", mod..":bananaleaves", mod..":birch_leaves", mod..":frost_leaves", mod..":orange_leaves", mod..":palmleaves", mod..":redwood_leaves", mod..":willow_twig", mod..":yellowleaves"},
			9,
			{mod..":bush", mod..":bush2", mod..":bush3", mod..":vine"},
			nil,
			type = t,
			group = dark
		})
	...
	ins(
		quests,
		{
			'unlock_moss',
			"Unlock Moss",
			"frost/jungle leaves or dry shrub/snowy grass",
			{mod..":frost_leaves", mod..":dry_shrub", mod..":snowygrass", "default:jungleleaves"},
			1,
			{mod..":crystal_moss", mod..":fiery_moss", mod..":gray_moss", mod..":green_moss"},
			{"dirt_digger", "leaves_digger"},
			type = t,
			group = dark
		})
	...
	ins(
		quests,
		{
			...
			2,
			{mod..":mushroom_soup", mod..":mushroom", mod..":mushroom_moss"},
			"wood_crafter",
			type = t,
			group = wood
		})
	...
	ins(
		...
		{
			'crystal_crafter_lover',
			"Crystal Crafter Lover",
			nil,
			{mod..":crystal_ingot"},
			1,
			{mod..":sword_crystal", mod..":crystal_gilly_staff"},
			"crystal_crafter",
			type = t,
			group = middle
		})
	...
	ins(
		quests,
		{
			...
			{mod..":crystal_ingot"},
			1,
			{mod..":axe_crystal", mod..":pick_crystal"},
			"crystal_crafter_lover",
			type = t,
			group = middle
		})
